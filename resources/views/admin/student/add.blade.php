                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required name="birthplace" id="inputName" placeholder="Nhập nơi sinh"
                                       class="form-control">
                                @error('name')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="father_name" required id="inputName" placeholder="Nhập tên đầy đủ"
                                       class="form-control">
                                @error('name')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="father_phone" required id="inputName" placeholder="Nhập số điện thoại"
                                       class="form-control">
                                @error('name')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mother_name" required id="inputName" placeholder="Nhập tên đầy đủ"
                                       class="form-control">
                                @error('name')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mother_phone" required id="inputName" placeholder="Nhập số điện thoại"
                                       class="form-control">
                                @error('name')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
