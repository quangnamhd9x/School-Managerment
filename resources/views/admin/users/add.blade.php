                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" required id="inputName" placeholder="Nhập tên tài khoản"
                                       class="form-control">
                                @error('username')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="inputName" required placeholder="Nhập email"
                                       class="form-control">
                                @error('email')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" required id="inputName" placeholder="Nhập mật khẩu"
                                       class="form-control">
                                @error('password')
                                <div style="color: red">{{ $message }}</div>
                                @enderror
