...
@include('admin.layout.core.main_sider')
...
@if(\Illuminate\Support\Facades\Session::has('message_toastr'))
    <script>
        toastr.success('{{ \Illuminate\Support\Facades\Session::get('message_toastr') }}')
    </script>
@endif
</body>
</html>
